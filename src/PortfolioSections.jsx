        ...
        <div className="project-card-modern">
          ...
          <div className="project-content-padded">
            ...
            <div className="project-action-row">
              ...
              <a href="https://aidashboardhere.netlify.app" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ fontSize: '0.85rem', padding: '0.6rem 1.25rem', border: '1px solid rgba(6, 182, 212, 0.3)', background: 'rgba(2, 4, 10, 0.6)' }}><ExternalLink size={16} /> LIVE DEMO</a>
            </div>
          </div>
        </div>
